...
public class SearchEngineIgnoreCaseWithTest {

    ISearchEngine searcher = new SearchEngineIgnoreCase(new EasySearch());
    ...
    public void casesTest1 () {
        ...
        Assertions.assertEquals(3, searcher.search(text, "Привет"));
    }
