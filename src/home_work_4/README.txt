...
home_work_3 tests - home_work_3\... (test names match the names of classes, that being tested, with the addition of an appendix "Test": *NameOfTestedClass*Test.java)