...
public class CalculatorWithCounterAutoCompositeTest extends CalculatorsAbstractTest {

    {this.calculator = new CalculatorWithCounterAutoComposite();}

    CalculatorWithCounterAutoComposite counterCalculator = new CalculatorWithCounterAutoComposite();
