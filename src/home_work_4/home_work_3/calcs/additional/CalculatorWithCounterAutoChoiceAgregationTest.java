...
public class CalculatorWithCounterAutoChoiceAgregationTest extends CalculatorsAbstractTest {

    {this.calculator = new CalculatorWithCounterAutoChoiceAgregation(new CalculatorWithOperator());}

    CalculatorWithCounterAutoChoiceAgregation counterCalculator = new CalculatorWithCounterAutoChoiceAgregation(new CalculatorWithOperator());
