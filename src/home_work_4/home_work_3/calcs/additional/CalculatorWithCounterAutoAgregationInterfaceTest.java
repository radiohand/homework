...
public class CalculatorWithCounterAutoAgregationInterfaceTest extends CalculatorsAbstractTest {

    {this.calculator = new CalculatorWithCounterAutoAgregationInterface(new CalculatorWithOperator());}

    CalculatorWithCounterAutoAgregationInterface counterCalculator =
